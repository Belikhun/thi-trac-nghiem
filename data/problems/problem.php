<?php
    ...
    function problemAdd(String $id, Array $add, Array $thumbnail = null, Array $attachment = null) {
        ...
        if ($moveThumbnail)
            move_uploaded_file($thumbnail["tmp_name"], PROBLEM_DIR ."/". $id ."/". $thumbnailFile);
    ...
    function problemEdit(String $id, Array $set, Array $thumbnail = null, Array $attachment = null) {
        ...
        if (isset($thumbnail)) {
            ...
            if (isset($problemList[$id]["thumbnail"]) && file_exists(PROBLEM_DIR ."/". $id ."/". $problemList[$id]["thumbnail"]))
                unlink(PROBLEM_DIR ."/". $id ."/". $problemList[$id]["thumbnail"]);
    
            move_uploaded_file($thumbnail["tmp_name"], PROBLEM_DIR ."/". $id ."/". $thumbnailFile);
    
            $new["thumbnail"] = $thumbnailFile;
        }
    ...
    function problemSubmit(String $id, String $username, Array $data) {
        ...
        (new fip(PROBLEM_DIR ."/$id/$username.submit", "a:0:{}")) -> write(serialize($data));
        return PROBLEM_OKAY;
    }

    function problemSubmitted(String $id, String $username) {
        return (problemExist($id) && file_exists(PROBLEM_DIR ."/$id/$username.submit"));
    }
    ...
    function problemGetSubmit(String $id, String $username) {
        ...
        return unserialize((new fip(PROBLEM_DIR ."/$id/$username.submit", "a:0:{}")) -> read());
    }
    ...
    function problemJudge(String $id, String $username) {
        ...
        $file = PROBLEM_DIR ."/$id/$username.submit";
        ...
        (new fip(PROBLEM_DIR ."/$id/$username.result", "a:0:{}")) -> write(serialize($result));
        return PROBLEM_OKAY;
    }

    function problemJudged(String $id, String $username) {
        return file_exists(PROBLEM_DIR ."/$id/$username.result");
    }
    ...
    function problemGetResult(String $id, String $username) {
        ...
        return unserialize((new fip(PROBLEM_DIR ."/$id/$username.result")) -> read());
    }
