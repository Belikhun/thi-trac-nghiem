...
const setup = {
	...
	async init() {
		...
		const intro = new this.Screen({
			name: "intro",
			title: "chào mừng!",
			description: "Cảm ơn bạn đã tin dùng <b>Thi Trắc Nghiệm</b>! Chỉ còn vài bước nữa là bạn đã hoàn thành việc cài đặt hệ thống!"
		});
		...
		intro.setup(async ({ screen, container, left, right }) => {
			...
			title.innerText = "Thi Trắc Nghiệm";
		...
		const completeScreen = new this.Screen({
			name: "complete",
			title: "hoàn thành!",
			description: `Bạn đã hoàn thành việc thiết lập <b>Thi Trắc Nghiệm</b>! Nếu có bất kì vướng mắc gì hãy tìm kiếm trên trang <b>Wiki</b> hoặc đặt câu hỏi trên trang Github của dự án!`
		});
